...
import { BASE_URL, COMMENT_URL } from "../constants";
        ...
        <div className="min-h-screen bg-gray-50 mt-20 md:mt-16">
            <div className="w-[95%] max-w-[1200px] mx-auto py-8 px-4">
                ...
                <div className="prose max-w-none mt-8">
                    <p className="text-xl font-medium text-gray-700 leading-relaxed whitespace-pre-wrap">
                        {body}
                    </p>
                </div>
